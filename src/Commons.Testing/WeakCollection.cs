//Copied from SharpDevelop source code ($Revision: 2683)
//see http://sourceforge.net/projects/sharpdevelop/
//Modifcations to original:
//- Renamed namespace to fit new home
//- Reformated code using Resharper

using System;
using System.Collections;
using System.Collections.Generic;

namespace Eca.Commons.Collections
{
    /// <summary>
